...
export default function UploadPage() {
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen w-full flex items-center justify-center p-6 noise-texture bg-surface z-10">
        {/* Background Decor: Tape & Floating Notes */}
        <div className="absolute top-10 right-10 w-32 h-10 bg-secondary-container opacity-40 -rotate-12 shadow-sm pointer-events-none"></div>
        <div className="absolute bottom-20 left-10 w-40 h-12 bg-outline-variant opacity-20 rotate-6 shadow-sm pointer-events-none"></div>

        {/* The Modal Container */}
        <div className="relative z-10 w-full max-w-md bg-surface-container-highest p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] border-none">
          {/* Close Action */}
          <button className="absolute -top-4 -right-4 bg-on-background text-background w-10 h-10 flex items-center justify-center hover:bg-primary-container transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
        ...
        {/* Decoration: Scrapbook Clippings */}
        <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0 overflow-hidden">
          <div className="absolute top-[10%] left-[5%] text-on-surface/5 font-headline font-black text-[12vw] leading-none select-none">
            ANALOG
            <br/>
            GHOSTS
          </div>
          <div className="absolute bottom-[5%] right-[5%] w-64 h-64 bg-primary-container/5 rounded-full blur-3xl"></div>
        </div>
      </main>
    </>
  )
